The IETF Network Management OPerations Working Group (NMOP WG) [1] was chartered by the IETF to focus on network management operations. The current topics of focus for the NMOP WG are as follows:
